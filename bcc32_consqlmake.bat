...
set __define__=%__cpu__% -DPACKETVER=6 -DNEW_006b -DFD_SETSIZE=4096 %__base__% %__NO_HTTPD__% %__ZLIB__% %__SKIP__% %__EXCLASS__% %__DYNAMIC_STATUS_CHANGE__% %__AC_MAIL__%
...
@echo コンバーターコンパイル
cd ..\converter
bcc32 -j255 %__warning__% %__define__% %__include__% char-converter.c libmysql.lib converter.c login-converter.c %__common__%
